...
def main():
    ...
    # I add this line to fix the error that quantize causes problem when model is in cpu
    ...
    logger.info("*** GOODOOGOODOOGOODOO ***")

    if training_args.do_train:
        logger.info("*** GOODOOGOODOOGOODOO ***  do_train")
    ...
    if training_args.do_eval:
        logger.info("*** GOODOOGOODOOGOODOO ***  do_eval")
    ...
    if training_args.do_predict:
        logger.info("*** GOODOOGOODOOGOODOO ***  do_predict")
        max_target_length = data_args.val_max_target_length
